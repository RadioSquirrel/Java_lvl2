...
public class Homework_5 {
    ...
    public void method1 () {
        ...
        System.out.println("Create array num.1. Put 1 into each [i].");
...
public void method2 () {
        ...
        System.out.println("Create array num.2. Put 1 into each [i].");

        for (int i = 0; i < arr.length; i++) {
            arr[i] = 1;
        }

        System.out.println("Maked 2 new arrays 'a1' , 'a2'.");
        long startTime = System.currentTimeMillis();
